	...
	<section class="category_filter">
		<div class="container">
			<ul id="filter_products">
				...
				<li class="filter motor"><a href="#" data-type="all" <?php if(!$tax) { echo 'class="active"'; } ?>>All</a></li>
				<?php $productTypes = get_terms( 'motor-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
				<?php foreach($productTypes as $productType) : ?>
					<li class="filter motor"><a href="#" data-type="<?php echo $productType->slug; ?>" <?php if($tax === $productType->slug) { echo 'class="active"'; } ?>><?php echo $productType->name; ?></a></li>
				<?php endforeach; ?>
			</ul>
		</div>
	</section>
			...
			<div class="mobile_filter">
				<div class="select">
					<select>
						...
						<?php $productTypesMob = get_terms( 'motor-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
			...
			<div class="products_wrap">
				<div class="grid">
					...
					<?php
						...
						$motor = new WP_Query($args);
					
						while( $motor->have_posts() ) : $motor->the_post();
					?>
					
					<?php $productCategories = get_the_terms($post->ID, 'motor-type'); ?>
					<?php 
