...
get_header(); ?>
	...
	<?php $manualLink = str_replace('-', '_', $manualLink); ?>
	...
	<section class="category_filter">
		<div class="container">
			<ul id="filter_products">
				...
				<?php $productTypes = get_terms( 'air-quality-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
		...
		<div class="mobile_filter">
			<div class="select">
				<select>
					...
					<?php $productTypesMob = get_terms( 'air-quality-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
		...
		<?php endif; ?>
			<div class="products_wrap">
				<div class="grid">
					...
					<?php $productCategories = get_the_terms($post->ID, 'air-quality-type'); ?>
					<?php 
