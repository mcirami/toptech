	...
	<section class="category_filter">
		<div class="container">
			<ul id="filter_products">
				...
				<?php $productTypes = get_terms( 'thermostat-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
			...
			<div class="mobile_filter">
				<div class="select">
					<select>
						...
						<?php $productTypesMob = get_terms( 'thermostat-type', array( 'child_of' => 0, 'hide_empty' => 0, )); ?>
			...
			<div class="products_wrap">
				<div class="grid">
					...
					<?php
						...
						$thermostat = new WP_Query($args);
					
						while( $thermostat->have_posts() ) : $thermostat->the_post();
					?>
			
					<?php $productCategories = get_the_terms($post->ID, 'thermostat-type'); ?>
					<?php 
						...
						<a class="product" href="<?php the_permalink(); ?>" data-id="<?php echo $i; ?>" data-type="<?php foreach ($productCategories as $productCategory){ echo $productCategory->slug . ' '; } ?>">
							<li>
								<div>
									...
									<?php endif; ?>
									<?php foreach ($productCategories as $productCategory){ $c++; } ?>
									<p class="<?php if($c >= 2){ echo 'multi_cat'; } ?>">
									<?php 
