...
//Template Name: Operation Manuals
...
<section class="manual_files">
	<div class="container">
							...
							?>
								...
								<?php if(have_rows('operation_manual')) : ?>								
									<?php while(have_rows('operation_manual')) : the_row(); ?>
										<?php if((get_sub_field('manual_link')) !== '') : ?>
											<li class="manual_link"><a href="<?php echo wp_get_attachment_url( get_sub_field( 'manual_link' ) ); ?>" target="_blank"><?php the_title(); ?></a></li>	
										<?php endif; ?>
									<?php endwhile; ?>
								<?php endif; ?>
		...
		<div class="manuals_right">
			<?php get_template_part('content', 'product-cat-sidebar'); ?>
		</div>
	</div>
</section>
