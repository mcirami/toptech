...
function add_custom_rewrite_rules( $rules ) {
	$new_rules = array(
			'thermostats-([^/]+)/?'	=> 'index.php?pagename=thermostats&tax=$matches[1]',			
			'motors-([^/]+)/?'		=> 'index.php?pagename=motors&tax=$matches[1]',
			'airquality-([^/]+)/?'	=> 'index.php?pagename=airquality&tax=$matches[1]',
			'chemicals-([^/]+)/?'	=> 'index.php?pagename=chemicals&tax=$matches[1]',
			'driers-([^/]+)/?'		=> 'index.php?pagename=driers&tax=$matches[1]',
			'techpure-flex'			=> 'index.php?techpure_flex=856-2',
			// add more rules here..
	);
